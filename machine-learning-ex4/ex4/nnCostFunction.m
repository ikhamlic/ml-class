...
for i=1:m
    ...
    yi(y(i))=1;
    JLocal=  -yi'*log(hi) - (1-yi)'*log(1-hi);
    J= J+JLocal;
    delta3=a3(:,i)-yi;
    delta2=Theta2'*delta3.*sigmoidGradient( [1;z2(:,i)] ); % 10*26 *26*1
...
Theta1_grad_reg=[zeros(hidden_layer_size,1), lambda* Theta1(:,[2:end])];

Theta2_grad_reg=[zeros(num_labels,1), lambda* Theta2(:,[2:end])];
